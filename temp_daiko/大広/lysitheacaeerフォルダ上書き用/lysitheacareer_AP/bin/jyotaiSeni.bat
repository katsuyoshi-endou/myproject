...
set BATCH_APP_JAR=%CAREER_HOME%\lib\jyotaiSeni-batch.jar
...
REM バッチログの出力ディレクトリ
set OUT_LOG_DIR=%CAREER_HOME%\log\batch\jyotaiSeni
...
REM "*** 状態遷移処理実行 ***"
%JAVA_COMMAND% -VBJclasspath %CLASSPATH% %PROPS% jp.co.hisas.addon.batch.learning.jyotaiSeni.main.JyotaiSeni %BATCH_SYSTEMPROPERTY% %OUT_LOG_DIR% 2> %OUT_LOG_DIR%\jyotaiSeni_Console.log
