...
import jp.co.hisas.career.app.talent.dto.VPzNValueDto;
...
public class VPzNValueDao {
    ...
    public VPzNValueDao(String loginNo) {
        this.loginNo = loginNo;
    }

    public VPzNValueDao(Connection conn) {
        this.conn = conn;
    ...
    public List<VPzNValueDto> selectDynamic(PreparedStatement pstmt) {

        Log.sql("[DaoMethod Call] VPzNValueDao.selectDynamic");
        ResultSet rs = null;
        try {
            rs = pstmt.executeQuery();
            List<VPzNValueDto> lst = new ArrayList<VPzNValueDto>();
            while ( rs.next() ) {
    ...
    public List<VPzNValueDto> selectDynamic(String sql) {
    ...
    private VPzNValueDto transferRsToDto(ResultSet rs) throws SQLException {

        VPzNValueDto dto = new VPzNValueDto();
