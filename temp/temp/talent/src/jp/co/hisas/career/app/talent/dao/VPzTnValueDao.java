...
import jp.co.hisas.career.app.talent.dto.VPzTnValueDto;
...
public class VPzTnValueDao {
    ...
    public VPzTnValueDao(String loginNo) {
        this.loginNo = loginNo;
    }

    public VPzTnValueDao(Connection conn) {
        this.conn = conn;
    ...
    public List<VPzTnValueDto> selectDynamic(PreparedStatement pstmt) {

        Log.sql("[DaoMethod Call] VPzTnValueDao.selectDynamic");
        ResultSet rs = null;
        try {
            rs = pstmt.executeQuery();
            List<VPzTnValueDto> lst = new ArrayList<VPzTnValueDto>();
            while ( rs.next() ) {
    ...
    public List<VPzTnValueDto> selectDynamic(String sql) {
    ...
    private VPzTnValueDto transferRsToDto(ResultSet rs) throws SQLException {

        VPzTnValueDto dto = new VPzTnValueDto();
